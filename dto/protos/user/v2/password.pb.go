...
func (x *CredentialPassword) Reset() {
	*x = CredentialPassword{}
...
func (x *CredentialPassword) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CredentialPassword) ProtoMessage() {}

func (x *CredentialPassword) ProtoReflect() protoreflect.Message {
	mi := &file_password_proto_msgTypes[0]
...
// Deprecated: Use CredentialPassword.ProtoReflect.Descriptor instead.
func (*CredentialPassword) Descriptor() ([]byte, []int) {
	return file_password_proto_rawDescGZIP(), []int{0}
}

func (x *CredentialPassword) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *CredentialPassword) GetCreatedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.CreatedAt
	}
	return nil
...
func (x *CredentialPassword) GetUpdatedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.UpdatedAt
	}
	return nil
...
func (x *CredentialPassword) GetUserID() string {
	if x != nil {
		return x.UserID
	}
	return ""
...
func (x *CredentialPassword) GetValue() string {
	if x != nil {
		return x.Value
	}
	return ""
...
func (x *CredentialToken) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *CredentialToken) GetCreatedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.CreatedAt
	}
	return nil
...
func (x *CredentialToken) GetUpdatedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.UpdatedAt
	}
	return nil
...
func (x *CredentialToken) GetUserID() string {
	if x != nil {
		return x.UserID
	}
	return ""
...
func (x *CredentialToken) GetValue() string {
	if x != nil {
		return x.Value
	}
	return ""
...
var file_password_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0xc6, 0x01, 0x0a, 0x12, 0x43, 0x72, 0x65, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c,
	...
	0x65, 0x72, 0x49, 0x44, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x05, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0xc3, 0x01, 0x0a, 0x0f, 0x43,
	0x72, 0x65, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x0e,
	...
	0x28, 0x09, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x44, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61,
...
var file_password_proto_goTypes = []interface{}{
	(*CredentialPassword)(nil),    // 0: CredentialPassword
	(*CredentialToken)(nil),       // 1: CredentialToken
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
}
var file_password_proto_depIdxs = []int32{
	2, // 0: CredentialPassword.createdAt:type_name -> google.protobuf.Timestamp
	2, // 1: CredentialPassword.updatedAt:type_name -> google.protobuf.Timestamp
	2, // 2: CredentialToken.createdAt:type_name -> google.protobuf.Timestamp
	2, // 3: CredentialToken.updatedAt:type_name -> google.protobuf.Timestamp
...
func file_password_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_password_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CredentialPassword); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
